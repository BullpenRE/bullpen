...
# Unless otherwise noted within a group, all gems must specify a version

gem 'active_storage_validations', '~> 0.9.2' # Validation set for activestorage
...
gem 'faraday', '~> 1.3'                     # HTTP client library needed for Bubble.io data migration
...
group :development, :test do
  ...
  gem 'dotenv-rails'                                    # Shim to load environment variables from .env into ENV in development, being used for Bubble.io data transfer. https://github.com/bkeepers/dotenv
