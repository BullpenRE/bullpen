...
describe('WorkEducationPage', () => {
  ...
  it('checks progress bar & Content card', () => {
    ...
    cy.get('div.container.cy-work-education')
      ...
      .find('div.d-flex.align-items-center.justify-content-between.mb-3.cy-education-present', { includeShadowDom: true})
      .get('div.w-100.cy-education-present')
      .get('div.row.cy-education-present.cy-institution')
      .get('div.col.mb-1.text.cy-education-present.cy-institution')
      .should(($div) => {
        expect($div).to.have.length(1)
      })
      .then(($div) => {
